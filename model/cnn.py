...
class CNN():
  ...
  def __init__(self, image_dim, final_vec_dim):
    ...
    l7 = ('hidden2', layers.DenseLayer)
    l8 = ('output',  layers.DenseLayer)
    ...
    self.net = NeuralNet(
      ...
      conv1_num_filters=50, conv1_filter_size=(3, 3), 
      pool1_pool_size=(3, 3),
      conv2_num_filters=25, conv2_filter_size=(5, 5),
      pool2_pool_size=(3, 3),
      hidden1_num_units=128,
      hidden2_num_units=24,
